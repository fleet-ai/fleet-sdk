...
if TYPE_CHECKING:
    from ..models.instance_ur_ls import InstanceURLs
...
class InstanceResponse:
    ...
    Attributes:
        ...
        team_id (str):
        region (str):
        urls (InstanceURLs): Model for instance URLs.
        terminated_at (Union[None, Unset, str]):
        health (Union[None, Unset, bool]):
    """
    ...
    health: Union[None, Unset, bool] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        urls = InstanceURLs.from_dict(d.pop("urls"))
        ...
        def _parse_health(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
