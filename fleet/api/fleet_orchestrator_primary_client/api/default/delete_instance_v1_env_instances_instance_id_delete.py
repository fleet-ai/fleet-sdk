...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/v1/env/instances/{instance_id}",
    }
...
) -> Optional[Union[HTTPValidationError, Instance]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, Instance]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, Instance]
    """
